...
//        Typeface type = Typeface.createFromAsset(getAssets(),"fonts/GreatVibes-Regular.otf");
//        textView.setTypeface(type);
//        textView.setText("\"You are the sweetest memories\"");


//        percentage.setText(i.getStringExtra("PERCENTAGE"));
//        day.setText(i.getStringExtra("DAY"));
//        week.setText(i.getStringExtra("WEEK"));

        mFirebaseDatabase = FirebaseDatabase.getInstance();
        mFirebaseDatabaseReference= mFirebaseDatabase.getReference("chat");
